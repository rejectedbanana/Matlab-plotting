function [tt] = titlein( str , h, varargin )

% function tt = titlein( str , h, varargin )
%
% Add a title to the inner upper right hand corner of the axes h.  Str is the text string. The
...
if nargin<3
    varargin =  {'fontsize', 16, 'fontweight', 'bold', 'verticalalignment', 'baseline' };
end
